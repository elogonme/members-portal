      ...
      >
          ...
          <v-app-bar-nav-icon>
            ...
            >
              ...
              <h2
                ...
                class="app-title text--primary text-capitalize"
              >
                {{ appName }}
              </h2>
            </router-link>
        ...
        <div class="d-flex align-center">
          <div v-show="$vuetify.breakpoint.mdAndUp">
            ...
            <a class="nav-bar-link mx-2">1 (888) 404 - 6623</a>
          </div>
          <app-bar-search
...
import navMenuItems from '@/navigation/landing'
...
import { mdiHeartOutline, mdiPhone, mdiMapMarker, mdiLogin } from '@mdi/js'
